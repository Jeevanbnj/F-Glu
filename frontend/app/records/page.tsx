...
export default function RecordsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-semibold text-gray-800">Records</h1>
        <p className="text-gray-500 mt-1">View and manage all patient prediction records</p>
      </div>
              ...
              {records.length === 0 ? (
                <tr>
                  <td colSpan={7} className="px-6 py-8 text-center text-gray-500">
                    No records found. Save a report from the Patients page to see it here.
                  </td>
                </tr>
              ) : (
                records.map((record) => (
                              ...
                              <div className="min-h-[100px] p-4 bg-gray-50 rounded-lg border border-gray-200">
                                {record.notes ? (
                                  ...
                                  <p className="text-gray-400 text-sm italic">
                                    No notes added for this record.
                                  </p>
                                )}
                              </div>
                            </div>
